...
def get_conversational_chain():
    prompt_template ="""
    You are an expert researcher and loves to read documents. 
    Answer the question as detailed as possible from the provided context, make sure to provide all the details including tables,formulas and images,
...
#Defining what our application will do once it receives user input
